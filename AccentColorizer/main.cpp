...
int APIENTRY WinMain(_In_ HINSTANCE hInstance,
    ...
    _In_ int       nCmdShow)
{
	hMutex = CreateMutexW(NULL, TRUE, L"ACCENTCOLORIZER");
	...
	wcex.lpszClassName = L"ACCENTCOLORIZER";
	if (!RegisterClassEx(&wcex))
	{
		return 2;
	}

	HWND hWnd = CreateWindowExW(0, L"ACCENTCOLORIZER", nullptr, 0, 0, 0, 0, 0, nullptr, NULL, NULL, NULL);
